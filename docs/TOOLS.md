...
and the generated [CHECKS.md](CHECKS.md) for the 157 checks it runs.
...
**157 checks**: 12 critical, 73 warnings, 72 notices. Sources: SF exports,
...
- [CHECKS.md](CHECKS.md) — the 157 checks the SF crawl audit runs, generated from the registry
