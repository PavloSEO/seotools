...
55 + 5 tools, reachable identically from the CLI and from MCP. One
...
and the generated [CHECKS.md](CHECKS.md) for the 149 checks it runs.
...
**149 checks**: 12 critical, 70 warnings, 67 notices. Sources: SF exports,
...
- [CHECKS.md](CHECKS.md) — the 149 checks the SF crawl audit runs, generated from the registry
