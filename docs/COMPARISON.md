...
The built-in 157-check importer targets Screaming Frog CSV/XLSX exports. Another crawler may still
...
The CLI and MCP server share the same 64 handlers, and five additional MCP tools cover the
...
Export mode evaluates Screaming Frog CSV/XLSX data against a 157-check registry without crawling
