...
The built-in 149-check importer targets Screaming Frog CSV/XLSX exports. Another crawler may still
...
The CLI and MCP server share the same 57 handlers, and five additional MCP tools cover the
...
Export mode evaluates Screaming Frog CSV/XLSX data against a 149-check registry without crawling
