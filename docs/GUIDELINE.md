...
back, and applies 157 checks to that evidence. Then a set of specialised tools answer questions
...
A health score computed from 16 of 157 checks is not a health score. The audit says so in
