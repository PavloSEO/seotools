...
- Screaming Frog produces the CSV/XLSX exports consumed by SEOHEAD's 152-check analyzer. Do not
...
seohead/
  ...
  sf/             Screaming Frog export runner and 152-check analyzer, shared with crawl/'s output
