...
- Screaming Frog produces the CSV/XLSX exports consumed by SEOHEAD's 149-check analyzer. Do not
...
seohead/
  ...
  sf/             Screaming Frog export runner and 149-check analyzer, shared with crawl/'s output
